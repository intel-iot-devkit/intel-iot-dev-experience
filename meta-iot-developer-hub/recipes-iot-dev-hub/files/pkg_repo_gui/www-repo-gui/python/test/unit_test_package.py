...
class TestPackage(unittest.TestCase):
    ...
    def test_get_data_installed(self):
        """ Test get_data_installed
        """
        u = manage_package.get_data_installed()
        print ""  # better print format
        print "Running test_get_data_installed."
        print u
        if u is None:
            self.assertTrue(True, 'no package file yet! ')
        else:
            self.assertIsInstance(u, str, 'get_data_installed fails with result ' + str(u))
